package com.time.master.tool;
 ...
 public class ChineseCalendar { 
  ...
  private final static String [] ChinaMonth={"一月","二月","三月","四月","五月","六月","七月","八月","九月","十月","冬月","腊月"};
  private final static String [] ChinaDay={"初一","初二","初三","初四","初五","初六","初七","初八","初九","初十",
	                                       "十一","十二","十三","十四","十五","十六","十七","十八","十九","廿十",
	                                       "廿一","廿二","廿三","廿四","廿五","廿六","廿七","廿八","廿九","三十"};
  public static String [] getChinaMonth(){
	  return ChinaMonth;
  }
  public static String getChinaMonth(int month){
	  return ChinaMonth[month];
  }
